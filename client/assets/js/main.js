...
document.addEventListener("DOMContentLoaded", () => {
  ...
  posts.forEach((post) => {
      ...
      // Ellipsis butonuna tıklandığında ilgili modal açılır
      postEllipsisDot.addEventListener("click", () => {
          ...
          // Sadece tıklanan ellipsis'e ait modal aç
          if (dotsModal) {
          ...
          // Eğer myPost-dots modal varsa ve postEllipsisDot'a tıklanırsa
          if (myPostDotsModal) {
      ...
      // Cancel butonuna tıklandığında ilgili modal kapanır
      if (dotsCancelBtn) {
      ...
      // MyPost Cancel butonuna tıklandığında ilgili modal kapanır
      if (myPostCancelBtn) {
